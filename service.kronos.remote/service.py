...
# Global lock: prevent concurrent Kodi API calls from multiple HTTP threads
...
class KronosRemoteRequestHandler(BaseHTTPRequestHandler):
    ...
    def _send_response(self, code: int, body: str,
        ...
        try:
            ...
            # Any unexpected handler error: ignore to keep server stable
            return
...
class KronosHTTPServer(ThreadingHTTPServer):
    # Fix: allow immediate restart/rebind on same port after TIME_WAIT
